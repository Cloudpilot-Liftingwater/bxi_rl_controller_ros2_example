...
export BXI_SONIC_SMPL_REF_CONTROL_ZMQ_HOST="${BXI_SONIC_SMPL_REF_CONTROL_ZMQ_HOST:-127.0.0.1}"
export BXI_SONIC_SMPL_REF_CONTROL_ZMQ_PORT="${BXI_SONIC_SMPL_REF_CONTROL_ZMQ_PORT:-5558}"
export BXI_SONIC_SMPL_REF_CONTROL_ZMQ_TOPIC="${BXI_SONIC_SMPL_REF_CONTROL_ZMQ_TOPIC:-smpl_ref_control}"
